          ...
          <div className="row d-flex justify-content-center">
            <div className="col-8">
              <form method='POST'>
                ...
                <div className="mb-3">
                  <label htmlFor="pid" className="form-label">Publicis sapient ID</label>
                ...
                <div className="mb-3">
                  <label htmlFor="fullname1" className="form-label">Start Date</label>
                ...
                <div className="mb-3">
                  <label htmlFor="exampleInputEmail1" className="form-label">Business Unit</label>
                ...
                <div className="mb-3">
                  <label htmlFor="fullname1" className="form-label">Project ID</label>
                ...
                <div className="mb-3">
                  <label htmlFor="People_manager" className="form-label">People manager</label>
                ...
                <div className="mb-3">
                  <label htmlFor="curr_status" className="form-label">Current Status</label>
                ...
                <div className="mb-3">
                  <label htmlFor="curr_org" className="form-label">Current organization</label>
                ...
                <div className="mb-3">
                  <label htmlFor="social_media" className="form-label">Social media link</label>
                ...
                <div className="mb-3">
                  <label htmlFor="office_location" className="form-label">Office Location</label>
